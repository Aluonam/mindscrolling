...
function arrancar(edicion) {
  ...
  // El cierre va siempre en la última pieza.
  ...
  // Una barra de progreso por pieza.
  piezas.forEach(() => {
  ...
  // Tiempo por palabra: crece con su longitud; los términos clave duran más.
  function duracion(nodo, posicion, factor) {
    ...
    // Gancho: las 5 primeras entran deprisa, luego ritmo de lectura normal.
  ...
  // Tocar: pausa/reanuda. Si ya terminó, reinicia.
  ...
  // Leída = destilado terminado. El tiempo de lectura es mejor señal que el
  // voto (decisión 9).
  ...
  // ---------- Ampliar la pieza ----------
  // Segundo nivel de lectura: título y resumen del autor (decisión 17).
  ...
  function abrirDetalle() {
    ...
    // El destilado se detiene mientras la ampliación está abierta.
...
/**
 * Parte el destilado en palabras y marca las claves que señaló la IA.
 *
